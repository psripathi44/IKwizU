...
if(isset($_POST["submit"])){
	...
	try{
		$quesAnsQueryStmt = "select question, optKey from quizbytoken where token = $token order by qNo ASC";
	...
	try{
		...
		$insScoreQueryStmt = "INSERT INTO scorebytoken (token, name, email, score, thisUserAnsKeyForToken) VALUES ($token, '{$inpName}', '{$inpEmail}', '{$lScore}', '{$userAnsKeyForToken}')";
